...
public class GroupMap<G,K,V> extends AbstractMap<K,V> {
    ...
    /**
     * Equivalent to calling {@code put(null, key, value) }
     *
    ...
    private Node<K, V> findNodeThatContains( Object obj ) {
        ...
        if( mValueComparator != null ) {
            ...
            do {
                if( value.equals( node.mValue ) ) { return node; }
    ...
    private GroupNode<K, V> findGroupNode( Object group ) {
        ...
        while( g != null ) {
            if( hash == g.mHash && (group == g.mGroup || group != null && group.equals( g.mGroup )) ) { return g; }
    ...
    private GroupNode<K, V> getGroupNodeInstance( G group ) {
        ...
        if( mGroupCount++ >= mGroupThreshold ) { resizeGroups( 2 * buckets.length ); }
    ...
    private Node<K, V> findKeyNode( K key ) {
        ...
        while( node != null ) {
            if( hash == node.mHash && (key == node.mKey || key.equals( node.mKey )) ) { return node; }
    ...
    private void removeNodeAll( Node<K, V> node ) {
        ...
        if( node.mAllLeft != null && node.mAllRight != null ) {
            ...
            while( swapNode.mAllRight != null ) { swapNode = swapNode.mAllRight; }
        ...
        if( node != null ) { node.mAllParent = newParent; }
        ...
        if( oldParent.mAllColor == RED ) { return; }
    ...
    private void rotateLeftAll( Node<K, V> node ) {
        ...
        if( node.mAllRight != null ) { node.mAllRight.mAllParent = node; }
    ...
    private void rotateRightAll( Node<K, V> node ) {
        ...
        if( node.mAllLeft != null ) { node.mAllLeft.mAllParent = node; }
    ...
    private void swapNodesAll( Node<K, V> a, Node<K, V> b ) {
        ...
        if( a.mAllLeft == b ) {
            ...
            b.mAllLeft = a;
            if( a.mAllLeft != null ) { a.mAllLeft.mAllParent = a; }

            tempNode = a.mAllRight;
            a.mAllRight = b.mAllRight;
            b.mAllRight = tempNode;
            if( a.mAllRight != null ) { a.mAllRight.mAllParent = a; }
            if( b.mAllRight != null ) { b.mAllRight.mAllParent = b; }
            ...
            b.mAllLeft = tempNode;
            if( a.mAllLeft != null ) { a.mAllLeft.mAllParent = a; }
            if( b.mAllLeft != null ) { b.mAllLeft.mAllParent = b; }
    ...
    private Node<K, V> firstNodeAll() {
        ...
        while( node.mAllLeft != null ) { node = node.mAllLeft; }
    ...
    private Node<K, V> lastNodeAll() {
        ...
        while( node.mAllRight != null ) { node = node.mAllRight; }
    ...
    private Node<K, V> nextNodeAll( Node<K, V> node ) {
        if( node.mAllRight != null ) {
            ...
            while( node.mAllParent != null && node.mAllParent.mAllRight == node ) { node = node.mAllParent; }
    ...
    private Node<K, V> prevNodeAll( Node<K, V> node ) {
        if( node.mAllLeft != null ) {
            ...
            while( node.mAllParent != null && node.mAllParent.mAllLeft == node ) { node = node.mAllParent; }
    ...
    private void removeNodeGroup( GroupNode<K, V> group, Node<K, V> node ) {
        ...
        if( node.mGroupLeft != null && node.mGroupRight != null ) {
            ...
            while( swapNode.mGroupRight != null ) { swapNode = swapNode.mGroupRight; }
        ...
        //Set parent of child node to be newParent.
        if( node != null ) { node.mGroupParent = newParent; }
        ...
        //If oldParent was RED, the constraints will be maintained.
        if( oldParent.mGroupColor == RED ) { return; }
    ...
    private void rotateLeftGroup( GroupNode<K, V> group, Node<K, V> node ) {
        ...
        if( node.mGroupRight != null ) { node.mGroupRight.mGroupParent = node; }
    ...
    private void rotateRightGroup( GroupNode<K, V> group, Node<K, V> node ) {
        ...
        if( node.mGroupLeft != null ) { node.mGroupLeft.mGroupParent = node; }
    ...
    private void swapNodesGroup( GroupNode<K, V> group, Node<K, V> a, Node<K, V> b ) {
        ...
        if( a.mGroupLeft == b ) {
            ...
            b.mGroupLeft = a;
            if( a.mGroupLeft != null ) { a.mGroupLeft.mGroupParent = a; }

            tempNode = a.mGroupRight;
            a.mGroupRight = b.mGroupRight;
            b.mGroupRight = tempNode;
            if( a.mGroupRight != null ) { a.mGroupRight.mGroupParent = a; }
            if( b.mGroupRight != null ) { b.mGroupRight.mGroupParent = b; }
            ...
            if( a.mGroupLeft != null ) { a.mGroupLeft.mGroupParent = a; }
            if( b.mGroupLeft != null ) { b.mGroupLeft.mGroupParent = b; }
    ...
    private Node<K, V> firstNodeGroup( GroupNode<K, V> group ) {
        ...
        while( node.mGroupLeft != null ) { node = node.mGroupLeft; }
    ...
    private Node<K, V> lastNodeGroup( GroupNode<K, V> group ) {
        ...
        while( node.mGroupRight != null ) { node = node.mGroupRight; }
    ...
    private Node<K, V> nextNodeGroup( Node<K, V> node ) {
        if( node.mGroupRight != null ) {
            ...
            while( node.mGroupParent != null && node.mGroupParent.mGroupRight == node ) { node = node.mGroupParent; }
    ...
    private Node<K, V> prevNodeGroup( Node<K, V> node ) {
        if( node.mGroupLeft != null ) {
            ...
            while( node.mGroupParent != null && node.mGroupParent.mGroupLeft == node ) { node = node.mGroupParent; }
    ...
    private Node<K, V> putKeyNode( G group, K key, V value ) {
        ...
        while( true ) {
            if( ret == null ) {
                ...
                if( mKeyCount >= mKeyThreshold ) { resizeKeys( buckets.length * 2 ); }

                break;

            } else if( hash == ret.mHash && key == ret.mKey || key.equals( ret.mKey ) ) {
                if( ret.mGroup == groupNode && ret.mValue == value ) { return ret; }
